...
% 
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
function ddt = mom_additive(t_mom, y, temperatureRamp, k1, k2, k3, p0, p1, p2, p3, p4, particleDensity, ...
...
if operationMode == 2 % concentration dependent operation
    temperature = interp1(temperatureRamp(1,:),temperatureRamp(2,:),concentration_mom);
else % time dependent operation
